...
public class CharacterImpl implements CharacterService{
	...
	public CharacterImpl(){
		...
		this.charBox = new RectangleHitboxImpl();
	}
	@Override
	public void init(int l, int s, boolean f) {
		...
		this.ready = false;
		//TODO: UTILISATION de RectangleHitboxContract
		//this.charBox = new RectangleHitboxImpl();//a renommer en hbImplem
		//RectangleHitboxContract hb = new  RectangleHitboxContract(hbImplem);
		charBox.init(0, 0);
		charBox.setWidthHeight(GlobalVariables.boxWidth, GlobalVariables.boxHeight);
	}
